 ...
 * {@link CSRFToken#HEADER_NAME} or the cookie {@link CSRFToken#COOKIE_NAME}.
 * If a valid token is present it will be attached to the Requests attributes
 * {@link RequestWeb#attribute(CSRFToken)}.
 * Otherwise this filter will raise an {@link CSRFTokenException}.
 * 
 * TODO: might not be a good idea to throw an exception here.
 * Currently this class is used to serve websites directly.
 * A redirect would be more sensible therefore.
 * 
 */
